...
public class TaggerDemo2  {
  ...
  public static void main(String[] args) throws Exception {
    ...
    BufferedReader r = new BufferedReader(new InputStreamReader(new FileInputStream("G:/π§≥Ã/workspace/±œ…Ë/jd-spider/src/main/java/static_resource/models/english-left3words-distsim.tagger"), "utf-8"));
